export default class m3 {
  ...
  static multiplyTwo(a: Matrix3, b: Matrix3): Matrix3 {
    var a00 = a[0 * 3 + 0]
    var a01 = a[0 * 3 + 1]
    var a02 = a[0 * 3 + 2]
    var a10 = a[1 * 3 + 0]
  ...
  static multiply(firstMatrix: Matrix3, ...restMatrices: Matrix3[]): Matrix3 {
    const matrices = Array.from(restMatrices)
    return matrices.reduce(
      (result, matrix) => this.multiplyTwo(result, matrix),
      firstMatrix
    )
  }
